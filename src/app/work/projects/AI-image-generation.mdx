...
- Implemented the full probabilistic encoder–decoder pipeline:
  ...
  - **VAE loss** combining **reconstruction loss (L1/L2)** and **KL-divergence regularization**:
    ...
    ![KL Divergence Loss](/images/projects/Image_Generation/L_KL.png "KL Loss")
    ![Total Loss](/images/projects/Image_Generation/L_total.png "Total Loss")
...
- Built a full adversarial pipeline:
  ...
  ![GAN Objective](/images/projects/Image_Generation/Gan_Objective.png "GAN Objective")
  <img src="/images/projects/Image_Generation/Gan_Objective.png" alt="Foo" sizeMobile="95" sizeTablet="70" sizeDesktop="50" title="GAN Objective" />
...
- Developed an end-to-end **Denoising Diffusion Probabilistic Model** following *Ho et al., 2020*.
  - **Forward Process:** Gradually corrupt images with Gaussian noise:
    ![Forward Diffsuion](/images/projects/Image_Generation/Forward_diffusion.png "Forward_diffusion")
    ![Forward Demo](/images/projects/Image_Generation/Forward_diff_epoch.png "Forward Demo")
  ...
  - **Reverse Process:** Train a neural network `ε_θ(x_t, t)` (UNet) to predict noise at each timestep and iteratively denoise to reconstruct `x_0`.
    ![Reverse Diffsuion](/images/projects/Image_Generation/Reverse_diffusion.png "Reverse_diffusion")
    ![Reverse Demo](/images/projects/Image_Generation/Reverse_diff_epoch.png "Reverse Demo")
...
<TechTable leftHeader="Category" rightHeader="Details">
...
![L2_L1](/images/projects/Image_Generation/VAE_L2_L1.png "Loss Difference")
...
![Mode Collapse](/images/projects/Image_Generation/Gan_mode_collapse.png "Mode Collapse")
...
![Outcomes](/images/projects/Image_Generation/Outcomes.png "FID Outcomes")
