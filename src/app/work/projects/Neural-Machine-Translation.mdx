...
- Each encoder step processes one token at a time and updates a hidden state, which serves as a running summary of all previous tokens. After reading the entire input sequence, the final hidden state of the encoder is passed to the decoder as a condensed vector representation of the source sentence. The decoder then generates each target token autoregressively.
  ...
  <Image src="/images/projects/NMT/LSTM3-SimpleRNN.png" alt="Simple-RNN" title="Simple-RNN" size="60" sizeMobile="100%" />
...
<Image src="/images/projects/NMT/LSTM_Steps.png" alt="LSTM-operation" title="LSTM Operations" size="50" sizeMobile="100%" />
<Image src="/images/projects/NMT/LSTM3-chain.png" alt="LSTM" title="LSTM" size="60" sizeMobile="100%" />
...
<Image src="/images/projects/NMT/RNN_Attention.png" alt="RNN-Attention" title="RNN with Attention" size="60" sizeMobile="100%" />
...
<Image src="/images/projects/NMT/attention.drawio.png" alt="Attention" title="Attention-Mechanism" size="50" sizeMobile="100%" />
...
- The key components include:
  ...
  - **Multi-Head Self-Attention:** Multiple attention heads operate in parallel, projecting input tokens into separate subspaces and attending to different contextual relationships simultaneously.
    ...
    - Attention weights are computed as:
      <Image src="/images/projects/NMT/attn.png" alt="Attention" title="Query, Key, and Value Weight Attention" size="50" sizeMobile="100%" />
      <Image src="/images/projects/NMT/mh_attn.png" alt="Multi-Head Attention" title="Multi-Head Attention" size="80" sizeMobile="100%" />
  ...
  <Image src="/images/projects/NMT/Transformer.png" alt="Transformer" title="Transformer Architecture" size="60" sizeMobile="100%" />
...
<TechTable leftHeader="Category" rightHeader="Details" alignDetails="left" columnWidthsResponsive={{ "10px": ["100px", "10%"], "10px": ["40px", "10%"] }}>
...
<TechTable columns={["Model","Train Loss","Val Loss","Train PPL","Val PPL","Summary / Insight"]} style={{ maxWidth: "clamp(720px, 90vw, 1200px)", width: "100%", overflowX: "auto", margin: "0 auto" }} columnWidths={["15%","11%","11%","11%","11%","41%"]}>
...
<TechTable columns={["Model","Train Loss","Val Loss","Train PPL","Val PPL","Summary / Insight"]} style={{ maxWidth: "clamp(720px, 90vw, 1200px)", width: "100%", overflowX: "auto", margin: "0 auto" }} columnWidths={["19%","10%","10%","10%","10%","41%"]}>
...
<TechTable columns={["Sentence", "German Tokenized Input", "True Translation", "LSTM with Attention", "Transformer (Encoder Only)", "Full Transformer"]} style={{ maxWidth: "clamp(720px, 90vw, 1200px)", width: "100%", overflowX: "auto", margin: "0 auto" }} columnWidths={["10%","21.5%","19%","14%","14%","21.5%"]}>
