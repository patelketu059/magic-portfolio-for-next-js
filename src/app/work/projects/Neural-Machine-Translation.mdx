...
<TechTable columns={["Sentence", "German Tokenized Input", "True Translation", "LSTM with Attention", "Transformer (Encoder Only)", "Full Transformer"]} style={{ maxWidth: "clamp(720px, 90vw, 1200px)", width: "100%", overflowX: "auto", margin: "0 auto" }}>
